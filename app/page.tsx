...
export default function Home() {
  const structuredData = { "@context": "https://schema.org", "@type": "WebSite", name: "Filekind", url: process.env.NEXT_PUBLIC_SITE_URL ?? "https://filekind.com", description: "Free browser tools for images and PDFs." };
